...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/data/macz/MRC-Crowd-main/fish',
                        help='orginal data directory')
    parser.add_argument('--train-list', default='VIMOC3.txt',
                        help='train list')
    parser.add_argument('--val-list', default='VIMOC2.txt',
                        help='val list')
    parser.add_argument('--data-dir', default='processed_VIMOC3',
    ...
    for phase in ['train', 'val', 'test']:
        ...
        if phase == 'train':
            ...
            with open(val_info) as f:
                for i in f:
                    im_list.append(os.path.join(args.origin_dir, 'Test', i.strip()))
        else:
